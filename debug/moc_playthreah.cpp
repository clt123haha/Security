/****************************************************************************
** Meta object code from reading C++ file 'playthreah.h'
**
...
#error "The header file 'playthreah.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 23, 6), // "addNum"
QT_MOC_LITERAL(5, 30, 1) // "i"

    },
    "PlayThread\0change\0\0img\0addNum\0i"
};
...
void PlayThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addNum((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayThread::change)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (PlayThread::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayThread::addNum)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void PlayThread::change(QImage _t1)
{
...
// SIGNAL 1
void PlayThread::addNum(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
