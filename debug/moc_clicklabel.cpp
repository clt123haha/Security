...
QT_MOC_LITERAL(3, 25, 7), // "labelId"
QT_MOC_LITERAL(4, 33, 17), // "labelClickedTwice"
QT_MOC_LITERAL(5, 51, 9), // "changeImg"
QT_MOC_LITERAL(6, 61, 3), // "img"
QT_MOC_LITERAL(7, 65, 7), // "saveImg"
QT_MOC_LITERAL(8, 73, 4), // "path"
QT_MOC_LITERAL(9, 78, 3) // "uid"

    },
    "ClickLabel\0labelClicked\0\0labelId\0"
    "labelClickedTwice\0changeImg\0img\0saveImg\0"
    "path\0uid"
};
...
void ClickLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->labelClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->labelClickedTwice((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->changeImg((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        case 3: _t->saveImg((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickLabel::labelClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ClickLabel::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClickLabel::labelClickedTwice)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ClickLabel::labelClicked(int _t1)
{
...
// SIGNAL 1
void ClickLabel::labelClickedTwice(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
